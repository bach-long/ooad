...
const JobDetail = () => {
  const job = {
    description: `-Tiếp nhận và phát triển nguồn khách hàng tìm năng thông qua các dữ liệu Marketing online
...
-Đàm phán và giải quyết nhu cầu của khách hàng tiềm năng và chốt đơn hàng`,
    method: `- Ưu tiên 6 tháng kinh nghiệm Telesale/Tư vấn tuyển sinh (trong lĩnh vực như: Giáo dục, ngân hàng, bảo hiểm, sale dược, spa, tư vấn tài chính, chứng khoán, xuất nhập khẩu, Logistics ......) trong năm 2021-2022
...
-Sử dụng thành tạo tin học văn phòng`,
    introduction: `Sau 3 năm thành lập, FutureLang là một trong các startup giáo dục công nghệ phát triển nhanh nhất Việt Nam (Định giá công ty hiện đạt >400 tỷ), với trên 400.000 người dùng, Công tý tiếp tục mở rộng quy mô với 2 dự án giáo dục công nghệ mới launching cùng với 4 dự án đang trong giai đoạn phát triển.
...
Địa chỉ công tyTrụ sở 1 tại 290 Nguyễn Trãi, Nam Từ Liêm, Hà NộiTrụ sở 2 : Số 10, Liền kề 12, Khu Đô Thị Văn Khê, Hà Đông`,
    remuneration: `Được tặng bộ sản phẩm học Tiếng Anh online trọn đời ngay tại FutureLang.
    ...
    <Col span={24}>
      ...
      <Row>
        <Col span={16} style={{ paddingLeft: 80 }}>
          <Row>
            <DescriptionBox title={"Mô tả công việc"}>
              <div className="text-description">{job.description}</div>
            </DescriptionBox>
          </Row>
          <Row>
            <DescriptionBox title={"Phương thức tuyển chọn"}>
              <div className="text-description">{job.method}</div>
            </DescriptionBox>
          </Row>
          <Row>
            <DescriptionBox title={"Giới thiệu công ty"}>
              <div className="text-description">{job.introduction}</div>
            </DescriptionBox>
          </Row>
          <Row>
            <DescriptionBox title={"Chế độ đãi ngộ"}>
              <div className="text-description">{job.remuneration}</div>
            </DescriptionBox>
          </Row>
